...
const ShowcaseHalfItem = ({ data }) => {
  ...
  return (
    <div className="w-full bg-white flex flex-col p-5 rounded-[10px]">
      <div className="w-full h-[150px] sm:h-[392px] overflow-hidden rounded-[10px] group">
        <img
          data-aos="fade-up"
          ...
          className="w-full h-full max-w-full rounded-[10px] object-cover group-hover:scale-105 duration-300"
        />
      </div>
      ...
      <div className="mb-5">
        <h3
          ...
          data-aos-duration="1000"
          data-aos-delay="500"
          className="text-bg-primary text-[28px] font-bold font-poppins mt-5"
        >
          {data.topTitle}
        </h3>
        ...
        <h5
          ...
          data-aos-duration="1000"
          data-aos-delay="500"
          className="text-black text-sm font-bold font-poppins leading-[150%] mt-[10px]"
        >
          {data.info}
        </h5>
        ...
        <p
          ...
          data-aos-duration="1000"
          data-aos-delay="500"
          className="text-black text-sm font-poppins leading-[150%] mt-[10px] line-clamp-6 h-0 sm:h-auto"
        >
          {data.description}
        </p>
      </div>
      ...
      {activeArticle && (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-end z-[51]">
          ...
          <div className="absolute top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] w-[90%] sm:w-[60%] h-[90%] sm:h-[80%] flex justify-center items-center rounded-[10px] overflow-y-scroll no-scrollbar bg-white">
            <div
              onClick={() => setActiveArticle(false)}
              className="absolute top-3 right-3 bg-bg-primary rounded-full w-8 h-8 sm:w-10 sm:h-10 flex justify-center items-center cursor-pointer"
            >
              <FaXmark className="text-white text-xl" />
            </div>

            <div className="w-full h-full bg-white flex flex-col justify-between px-5 py-5 sm:py-10 sm:px-10 rounded-[10px]">
              <img
                src={data.imgUrl}
                alt="Showcase Item Image"
              ...
              <div>
                ...
                <button
                  onClick={() => setActiveArticle(false)}
                  className="px-10 py-2 sm:px-[72px] sm:py-[14px] rounded-full border-2 border-bg-primary mt-6 mb-10 hover:bg-bg-primary hover:text-white duration-300"
                >
                  Close
                </button>
              </div>
...
export default ShowcaseHalfItem;
