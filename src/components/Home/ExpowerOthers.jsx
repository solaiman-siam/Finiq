      ...
      <Container>
        <div className="pt-24">
          <div className="flex w-full items-center flex-col  justify-center gap-4 pb-12">
            ...
            <p className="text-text-primary w-4/12 text-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="bg-[#F6ECE6] shadow-lg rounded-xl overflow-hidden">
              <div className="relative overflow-hidden rounded-xl h-[240px]">
                <img className="absolute top-0 left-0 z-[4]  object-cover" src={Empower1} alt="" />
                <div className="absolute z-[6] bg-bg-overlay/70 w-full h-full">
                <img className="top-1/2 z-[8] left-1/2 absolute w-60 -translate-x-1/2 -translate-y-1/2" src={EmpowerIcon1} alt="" />
                </div>
              </div>
              <div className="p-5 text-text-dark ">
                <p>Porta ac tincidunt malesuada egestas sit. Mauris in varius ut elementum facilisi dolor porttitor praesent. Erat.</p>
              </div>
            </div>
            {/* item 2 */}
            <div className="bg-[#F6ECE6] shadow-lg rounded-xl overflow-hidden">
              <div className="relative overflow-hidden rounded-xl h-[240px]">
                <img className="absolute top-0 left-0 z-[4]  object-cover" src={Empower2} alt="" />
                <div className="absolute z-[6] bg-bg-overlay/70 w-full h-full">
                <img className="top-1/2 z-[8] left-1/2 absolute w-60 -translate-x-1/2 -translate-y-1/2" src={EmpowerIcon2} alt="" />
                </div>
              </div>
              <div className="p-5 text-text-dark ">
                <p>Porta ac tincidunt malesuada egestas sit. Mauris in varius ut elementum facilisi dolor porttitor praesent. Erat.</p>
            ...
            <div className="bg-[#F6ECE6] shadow-lg rounded-xl overflow-hidden">
              <div className="relative overflow-hidden rounded-xl h-[240px]">
                <img className="absolute top-0 left-0 z-[4]  object-cover" src={Empower3} alt="" />
                <div className="absolute z-[6] bg-bg-overlay/70 w-full h-full">
                <img className="top-1/2 z-[8] left-1/2 absolute w-60 -translate-x-1/2 -translate-y-1/2" src={EmpowerIcon3} alt="" />
                </div>
              </div>
              <div className="p-5 text-text-dark ">
                <p>Porta ac tincidunt malesuada egestas sit. Mauris in varius ut elementum facilisi dolor porttitor praesent. Erat.</p>
